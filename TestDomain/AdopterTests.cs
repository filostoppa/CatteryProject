...
public class AdopterTests
{
    ...
    public void AdopterCostructor_FirstName_WorksCorrectly()
    {
        ...
        Adopter adopter = new Adopter("John", "Doe", email, notes, phone, fiscalCode, "New York", cap);
    ...
    public void AdopterCostructor_NullOrEmptyFirstName_ThrowsArgumentNullException()
    {
        ...
        FiscalCode fiscalCode = new FiscalCode("ABCDEF12G34H567I");
        Cap cap = new Cap("47042");
        Assert.ThrowsException<ArgumentNullException>(() => new Adopter("", "Doe", email, notes, phone, fiscalCode, "New York", cap));
    }
    [TestMethod]
    public void AdopterCostructor_NullOrEmptyLastName_ThrowsArgumentNullException()
    {
        ...
        FiscalCode fiscalCode = new FiscalCode("ABCDEF12G34H567I");
        Cap cap = new Cap("47042");
        Assert.ThrowsException<ArgumentNullException>(() => new Adopter("John", "", email, notes, phone, fiscalCode, "New York", cap));
    }
    [TestMethod]
    public void AdopterCostructor_NullOrEmptyCity_ThrowsArgumentNullException()
    {
        ...
        FiscalCode fiscalCode = new FiscalCode("ABCDEF12G34H567I");
        Cap cap = new Cap("47042");
        Assert.ThrowsException<ArgumentNullException>(() => new Adopter("John", "Doe", email, notes, phone, fiscalCode, "", cap));
    }
    [TestMethod]
    public void AdopterCostructor_InvalidPhone_ThrowsArgumentNullException()
    {
        ...
        FiscalCode fiscalCode = new FiscalCode("ABCDEF12G34H567I");
        Cap cap = new Cap("47042");
        Assert.ThrowsException<ArgumentNullException>(() => new Adopter("John", "Doe", email, notes, phone, fiscalCode, "New York", cap));
    }
    [TestMethod]
    ...
    public void AdopterCostructor_InvalidCap_ThrowsArgumentNullException()
    {
        ...
        Assert.ThrowsException<ArgumentException>(() => new Adopter("John", "Doe", email, notes, phone, fiscalCode, "New York", cap));
    }
}